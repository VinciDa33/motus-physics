...
class Program
{
    static void Main(string[] args)
    {
        ...
        TestCircle t2 = new TestCircle(new Vector(300, 500), 50d);
        TestCircle t3 = new TestCircle(new Vector(320, 300), 50d);
        ...
        TestRigid ri2 = new TestRigid(new Vector(300, 300), new Vector(50, 50));
        ri2.Rotate(45f);
